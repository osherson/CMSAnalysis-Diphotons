...
saveTreeFolder = "/cms/sclark-2/DiPhotonsTrees/Signals/" 
...
def Treemaker(folder, Dataset, isData, year):
  ...
  for b in Branches:
    ...
    Rdf = Rdf.Define("clu1_j_dr","clu_to_jet_DR[pt_idx_1]")
    Rdf = Rdf.Define("clu2_j_dr","clu_to_jet_DR[pt_idx_2]")
    #Iso, masym, deta
    ...
    branchList.push_back("clu1_j_dr")
    branchList.push_back("clu2_j_dr")
