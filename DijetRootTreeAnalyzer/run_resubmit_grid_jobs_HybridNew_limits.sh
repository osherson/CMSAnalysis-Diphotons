## Grid resubmissions for *final* limits with HybridNew for RPV masses of 500 GeV and above (up to 3 TeV)
## Run this if CRAB jobs fail
## August 2021
...
crab resubmit HybridNew_RPV/crab_final_hybridNew_limits_3_slices_Envelope_3_func_M"$rpv"
