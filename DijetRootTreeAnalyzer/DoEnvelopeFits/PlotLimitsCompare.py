...
def MakeLimitPlot(x1, exp1, x2, exp2, sig_alpha):
  ...
  L.SetLineColor(0)
  L.SetFillColor(0)
  L.AddEntry(Exp1, "No Alpha Slicing", "PL")
  L.AddEntry(Exp2, "Alpha Sliced", "PL")
...
onebig_dir = "saveOutput/OneBigBin/combineOutput/"
slice_dir = "allAlphaLimitMaker/combineOutput/"
for sa in [0.005, 0.01, 0.015, 0.02, 0.025, 0.03]:
  x1,exp1 = GetExpLimit(onebig_dir, sa)
  x2,exp2 = GetExpLimit(slice_dir, sa)
  MakeLimitPlot(x1,exp1,x2,exp2, sa)
