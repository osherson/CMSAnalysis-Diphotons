...
newDir = "combineOutputEnvelope/{}_{}".format(an,mm)
...
#gPad.SetTicks(1,1)
#gPad.RedrawAxis()
#C.Print("{}/PostFits_envelope__{}_{}.png".format(newDir,an,mm))
#C.Print("{}/PostFits_envelope_{}_{}.root".format(newDir,an,mm))
#
...
gPad.SetTicks(1,1)
gPad.RedrawAxis()
C_KS.Print("{}/GoF_envelope_{}_{}.png".format(newDir,an,mm))
C_KS.Print("{}/GoF_envelope_{}_{}.root".format(newDir,an,mm))
...
for i,j in zip(Lc,Ln):
	...
	C_B.cd()
	H.Draw("e0")
	C_B.Print(newDir+"/"+j+"_envelope_{}_{}.png".format(an,mm))
	C_B.Print(newDir+"/"+j+"_envelope_{}_{}.root".format(an,mm))
