...
for nc in range(1,nchan+1):
  ...
  gPad.SetTicks(1,1)
  gPad.RedrawAxis()
  C.Print("{}/PostFits_{}_{}_{}_ch{}.png".format(newDir,an,mm,fit,nc))
  C.Print("{}/PostFits_{}_{}_{}_ch{}.root".format(newDir,an,mm,fit,nc))
...
for i,j in zip(Lc,Ln):
  ...
  T.Draw("(r-%f)"%i+"/rErr>>Bias Test,fm1, injected r=" + j, "fit_status == -1")
  T.Draw("(r-%f)"%i+"/rErr>>Bias Test,f0, injected r=" + j, "fit_status == 0")
  T.Draw("(r-%f)"%i+"/rErr>>Bias Test,fp1, injected r=" + j, "fit_status == 1")
  ...
  ROOT.gStyle.SetOptFit(1111)
  Hm1.Draw("e0")
  fname = newDir+"/{}_fitstatusm1_{}_{}_{}".format(j,an,mm,fit)
  ...
  ROOT.gStyle.SetOptFit(1111)
  Hp1.Draw("e0")
  fname = newDir+"/{}_fitstatusp1_{}_{}_{}".format(j,an,mm,fit)
  ...
  ROOT.gStyle.SetOptFit(1111)
  H0.Draw("e0")
  fname = newDir+"/{}_fitstatus0_{}_{}_{}".format(j,an,mm,fit)
  ...
  H0.Draw("e0same")
  Leg.Draw("same")
  fname = newDir+"/{}_fitstatus_{}_{}_{}".format(j,an,mm,fit)
