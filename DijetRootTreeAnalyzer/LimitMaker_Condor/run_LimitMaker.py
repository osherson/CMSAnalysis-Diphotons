...
have = [ff for s,d,ff in os.walk("{}/../combineOutput/{}/".format(dir_path,year))][0]
...
for sig, sdir in gen_signals.items():
  ...
  #print(eff / 1000)
  os.system("cd ..")
  os.system("python {}/../python/DiphotonCardMakerSingle.py -f dijet -l {} -y {} -s {} -x {}".format(dir_path,LUMI[year]/10, year, sig, eff/1000))
  os.system("combine {}/../output/dijet_combine_gg_{}_lumi-5.990_diphoton_dijet.txt -M AsymptoticLimits".format(dir_path,xm))
  os.system("mv higgsCombineTest.AsymptoticLimits.mH120.root {}/../combineOutput/{}/X{}.root".format(dir_path,year,xm))
