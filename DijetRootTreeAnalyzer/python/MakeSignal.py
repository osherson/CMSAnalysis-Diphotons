        ...
        if not interpoBool:
            for sl in range(len(ALPHS)):
                ...
                for tree in TREES:
                    ...
                    file = ROOT.TFile("/cms/sclark/DiphotonAnalysis/CMSSW_11_1_0_pre7/src/CMSAnalysis-Diphotons/DijetRootTreeAnalyzer/inputs/rpv_M%d_%s_asl%d" % (int(m), tree, sl if o.ALPH is None else o.ALPH) + ("_no4J" if o.NOFJ else "") + ".root", "recreate")
                    ...
                    print("|===> Saving template at: %s" % ("/cms/sclark/DiphotonAnalysis/CMSSW_11_1_0_pre7/src/CMSAnalysis-Diphotons/DijetRootTreeAnalyzer/inputs/rpv_M%d_%s_asl%d" % (int(m), tree, sl if o.ALPH is None else o.ALPH) + ("_no4J" if o.NOFJ else "") + ".root"))
                    file.cd()
                    D.Write()
                    file.Close()
            ...
            for sl in range(len(ALPHS)):
                ...
                for tree in TREES:
                    ...
                    file = ROOT.TFile("/cms/sclark/DiphotonAnalysis/CMSSW_11_1_0_pre7/src/CMSAnalysis-Diphotons/DijetRootTreeAnalyzer/inputs/rpv_M" + str(m).replace(".", "_") + "_%s_asl%d" % (tree, sl if o.ALPH is None else o.ALPH) + ("_no4J" if o.NOFJ else "") + ".root", "recreate")
                    INPUTH = []
                    ...
                    print("|===> Saving template at: %s" % ("/cms/sclark/DiphotonAnalysis/CMSSW_11_1_0_pre7/src/CMSAnalysis-Diphotons/DijetRootTreeAnalyzer/inputs/rpv_M" + str(m).replace(".", "_") + "_%s_asl%d" % (tree, sl if o.ALPH is None else o.ALPH) + ("_no4J" if o.NOFJ else "") + ".root"))
                    file.cd()
                    E.Write()
                    file.Close()
