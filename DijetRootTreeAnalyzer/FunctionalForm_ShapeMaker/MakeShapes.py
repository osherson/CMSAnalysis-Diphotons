...
DATA_DIR = "/cms/sclark/DiphotonAnalysis/CMSSW_11_1_0_pre7/src/CMSAnalysis-Diphotons/DijetRootTreeAnalyzer/inputs/Shapes_DATA/alphaBinning/ALL/"
...
def GetShape(X, A, T):
  ...
  fil = TFile("/cms/sclark/DiphotonAnalysis/CMSSW_11_1_0_pre7/src/CMSAnalysis-Diphotons/DijetRootTreeAnalyzer/inputs/Shapes_fromGen/unBinned/X{}A{}/Sig_{}.root".format(X,A,T),"read")
  hist = fil.Get("h_AveDijetMass_1GeV")
  oT = hist.Clone("H_X{}A{}".format(X,A))
...
def WriteEff(wx, wa, frac, odir):
   ...
   fullEffFile=open("./EffFiles/FULL.csv","r")
    ...
    for x in fine_xs:
      ...
      for alpha in fine_alphas:
        ...
        if(shape=="X"):
          ...
          #N = GetShape(int(x), int(a), tname).Integral()
          #N = GetShape(int(x), int(a), tname)
          #print N, y
          oF.cd()
