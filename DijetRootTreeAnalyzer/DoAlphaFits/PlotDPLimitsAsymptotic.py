...
def MakeLimitPlot(alphaBin, function):
  ...
  lset = list(alphas)
  if(len(lset)>1): print("Hey you better check this out")
  alpha=float(lset[0])
...
#  L.AddEntry(TH9, "X #rightarrow #phi#phi #rightarrow (#gamma#gamma)(#gamma#gamma) [f/N = 9]", "L")
  ...
  MakeFolder("LimitPlots/{}".format(function))
  savename="LimitPlots/{}/Lim_RunII_alphaBin{}_alpha{}_{}.png".format(function, alphaBin, str(alpha).replace(".","p"), function)
