...
public:
   ...
   RooDijet3ParamBinPdf(const char *name, const char *title,
   ...
   RooDijet3ParamBinPdf(const char *name, const char *title,
		  ...
		  RooAbsReal& _p2,
		  RooAbsReal& _sqrts);
   RooDijet3ParamBinPdf(const RooDijet3ParamBinPdf& other,
      const char* name = 0);
...
private:
   ClassDef(RooDijet3ParamBinPdf,1) // RazorDijet3ParamBinPdf function
...
public:
   ...
   {
      return new Dijet3ParamFunction();
   }
